  ...
  return (
    <section id="expertise" ref={sectionRef} className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        {/* Section Title */}
        <div className="expertise-title opacity-0 flex items-center gap-4 mb-8 md:mb-16">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {area.skills.map((skill) => (
                            <span
                              key={skill}
                              className={`px-3 md:px-4 py-1.5 md:py-2 bg-muted/50 text-foreground text-sm font-mono rounded-lg border border-border hover:${colors.border} transition-colors cursor-default`}
                            >
                              {skill}
                            </span>
                          ))}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {area.tools.map((tool) => (
                            <span
                              key={tool}
                              className={`px-3 md:px-4 py-1.5 md:py-2 border ${colors.border} text-sm font-mono rounded-lg ${colors.text} hover:${colors.bg} transition-colors cursor-default`}
                            >
                              {tool}
                            </span>
                          ))}
