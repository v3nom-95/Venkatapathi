  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden scanline">
      ...
      <div ref={containerRef} className="container mx-auto px-6 relative z-10 text-center">
        ...
        <h1 className="hero-name text-5xl md:text-7xl lg:text-8xl font-bold mb-6">
        ...
        {/* Subtitle */}
        <p className="hero-subtitle text-xl md:text-2xl text-muted-foreground font-mono mb-8 opacity-0">
        ...
        {/* CTA */}
        <div className="hero-subtitle opacity-0 flex justify-center gap-4">
          <button 
