...
export const NetworkSecurityViz = ({ type }: NetworkSecurityVizProps) => {
  ...
  if (type === 'red') {
    return (
      <div ref={containerRef} className="relative w-full h-[180px] sm:h-[220px] md:h-[300px]">
  ...
  if (type === 'ai') {
    return (
      <div ref={containerRef} className="relative w-full h-[180px] sm:h-[220px] md:h-[300px] bg-black/5 rounded-2xl overflow-hidden border border-primary/10">
        <svg viewBox="0 0 300 200" className="w-full h-full">
          <defs>
